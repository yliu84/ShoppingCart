...
namespace CmsShoppingCart.Areas.Admin.Controllers
{
    ...
    public class ShopController : Controller
    {
        ...
        //POST:Admin/shop/ReorderCatgories
        [HttpPost]
        ...
        public ActionResult EditProduct(ProductVM model, HttpPostedFileBase file)
        {
            ...
            if(file != null && file.ContentLength > 0)
            {
                ...
                DirectoryInfo dl1 = new DirectoryInfo(pathString1);
                DirectoryInfo dl2 = new DirectoryInfo(pathString2);

                foreach (FileInfo file2 in dl1.GetFiles())
                    file2.Delete();

                foreach (FileInfo file3 in dl2.GetFiles())
                    file3.Delete();
